...
<head>
    ...
    <title>เพิ่มรูปพันธ์ไม้และสัตว์ป่า</title>
</head>
...
<body>
    <div class="main-content">
        <h3>เพิ่มข้อมูล</h3>
        <div class="cover_">
            <form action="save_addplantimg.php" method="post" enctype="multipart/form-data">
                <div class="form-group row" style="width:50%;">
                    <label for="staticEmail" class="col-sm-4 col-form-label">รูป</label>
                    <div class="col-sm-8">
                        <input type="file" name="pi_img" class="form-control" style="float:right;" required accept=".jpg, .jpeg , .png"><br>
